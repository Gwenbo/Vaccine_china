...
## prevalence plot
par(mfrow=c(2,3))
plot(seq(1970,2050),TBPb[71:151,1], ylab="Prevalence/100,000pop",xlab="year", ylim=c(0,300),main="Total Prevalence",type='l',col='orange')
...
plot(seq(1970,2050),TBPb[71:151,3], ylab="Prevalence/100,000pop",xlab="year", ylim=c(0,300),main="15-29years Prevalence",type='l',col='blue')
...
plot(seq(1970,2050),TBPb[71:151,4], ylab="Prevalence/100,000pop",xlab="year", ylim=c(0,300),main="30-44years Prevalence",type='l',col='green')
...
plot(seq(1970,2050),TBPb[71:151,5], ylab="Prevalence/100,000pop",xlab="year", ylim=c(0,300),main="45-59years Prevalence",type='l',col='pink')
...
plot(seq(1970,2050),TBPb[71:151,6], ylab="Prevalence/100,000pop",xlab="year", ylim=c(0,700),main="60+ years Prevalence",type='l',col='red')
