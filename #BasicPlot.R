...
## Mortality plot
par(mfrow=c(2,2))
plot(seq(1970,2050),TBM[71:151,1], ylab="Mortality/100,000pop/yr",xlab="year", ylim=c(0,100),main="Total Mortality",type='l',col='orange')
points(2010,mortality2010[1])
segments(2010,mortality2010l[1],2010,mortality2010u[1])
plot(seq(1970,2050),TBM[71:151,2], ylab="Mortality/100,000pop/yr",xlab="year", ylim=c(0,50),main="0-14years Mortality",type='l',col='red')
points(2010,mortality2010[2])
segments(2010,mortality2010l[2],2010,mortality2010u[2])
plot(seq(1970,2050),TBM[71:151,6], ylab="Mortality/100,000pop/yr",xlab="year", ylim=c(0,100),main="15-59years Mortality",type='l',col='blue')
points(2010,mortality2010[3])
segments(2010,mortality2010l[3],2010,mortality2010u[3])
plot(seq(1970,2050),TBM[71:151,7], ylab="Mortality/100,000pop/yr",xlab="year", ylim=c(0,100),main="60+years Mortality",type='l',col='green')
