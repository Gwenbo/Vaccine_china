...
plot(seq(1990,2050),TBI[91:151,2], ylab="Incidence/100,000pop/yr",xlab="Year", ylim=c(0,600),main="All-Tuberculosis Incidence Rate: 0-14 years",type='l',col='red')
points(2010,incidence2010[2])
segments(2010,incidence2010l[2],2010,incidence2010u[2])
plot(seq(1990,2050),TBI[91:151,3], ylab="Incidence/100,000pop/yr",xlab="Year", ylim=c(0,600),main="All-Tuberculosis Incidence Rate: 15-54 years",type='l',col='blue')
points(2010,incidence2010[3])
segments(2010,incidence2010l[3],2010,incidence2010u[3])
plot(seq(1990,2050),TBI[91:151,4], ylab="Incidence/100,000pop/yr",xlab="Year", ylim=c(0,600),main="All-Tuberculosis Incidence Rate: 55-64 years",type='l',col='purple')
points(2010,incidence2010[4])
segments(2010,incidence2010l[4],2010,incidence2010u[4])
plot(seq(1990,2050),TBI[91:151,5], ylab="Incidence/100,000pop/yr",xlab="Year", ylim=c(0,600),main="All-Tuberculosis Incidence Rate: ≥65 years",type='l',col='green')
...
plot(seq(1990,2050),TBPb[91:151,3], ylab="Prevalence/100,000population",xlab="Year", ylim=c(0,700),main="Bacteriologically-positive tuberculosis prevalence rate: 15-29 years",type='l',col='lightblue')
...
plot(seq(1990,2050),TBPb[91:151,4], ylab="Prevalence/100,000population",xlab="Year", ylim=c(0,700),main="Bacteriologically-positive tuberculosis prevalence rate: 30-44 years",type='l',col='blue')
...
plot(seq(1990,2050),TBPb[91:151,5], ylab="Prevalence/100,000population",xlab="Year", ylim=c(0,700),main="Bacteriologically-positive tuberculosis prevalence rate: 45-59 years",type='l',col='purple')
...
plot(seq(1990,2050),TBPb[91:151,6], ylab="Prevalence/100,000population",xlab="Year", ylim=c(0,700),main="Bacteriologically-positive tuberculosis prevalence rate: ≥60 years",type='l',col='green')
...
plot(seq(1990,2050),TBM[91:151,2], ylab="Mortality/100,000pop/yr",xlab="Year", ylim=c(0,8),main="Tuberculosis Mortality Rate: 0-14 years",type='l',col='red')
points(2010,mortality2010[2])
segments(2010,mortality2010l[2],2010,mortality2010u[2])
plot(seq(1990,2050),TBM[91:151,6], ylab="Mortality/100,000pop/yr",xlab="Year", ylim=c(0,80),main="Tuberculosis Mortality Rate: 15-59 years",type='l',col='blue')
...
plot(seq(1990,2050),PSIZEy[91:151,2], ylab="Population (thousands)",xlab="year", ylim=c(0,1000000),main="0-14years Population",type='l',col='red')
points(2050,population2050[2])
points(2010,population2010[2])
segments(2050,population2050l[2],2050,population2050u[2])
plot(seq(1990,2050),PSIZEy[91:151,3], ylab="Population (thousands)",xlab="year", ylim=c(0,1000000),main="15-54years Population",type='l',col='blue')
points(2050,population2050[3])
points(2010,population2010[3])
segments(2050,population2050l[3],2050,population2050u[3])
plot(seq(1990,2050),PSIZEy[91:151,4], ylab="Population (thousands)",xlab="year", ylim=c(0,1000000),main="55-64years Population",type='l',col='purple')
points(2050,population2050[4])
points(2010,population2010[4])
segments(2050,population2050l[4],2050,population2050u[4])
plot(seq(1990,2050),PSIZEy[91:151,5], ylab="Population (thousands)",xlab="year", ylim=c(0,1000000),main="65+ years Population",type='l',col='green')
...
plot(seq(1990,2050),TBRa[91:151,2], ylab="%",xlab="year", ylim=c(0,100),main="0-14years  New Infection vs Reactivation",type='l',col='red')
lines(seq(1990,2050),TBRi[91:151,2],lty=5,col='red')
#lines(seq(1970,2050),((TBRi[71:151,2])+TBRa[71:151,2]),lty=5,col='red')
plot(seq(1990,2050),TBRa[91:151,3], ylab="%",xlab="year", ylim=c(0,100),main="15-54years New Infection vs Reactivation",type='l',col='blue')
